...
import gaei.cn.baseapp.net.constants.HttpConstants;
import gaei.cn.baseapp.net.https.SSLUtils;
import gaei.cn.baseapp.net.interceptor.AddCookiesInterceptor;
import gaei.cn.baseapp.net.interceptor.HeaderInterceptor;
import gaei.cn.baseapp.net.interceptor.HttpCacheInterceptor;
import gaei.cn.baseapp.net.interceptor.ReceivedCookiesInterceptor;
...
public class SingleRxHttp {
    ...
    private OkHttpClient.Builder getSingleOkHttpBuilder() {
        ...
        singleOkHttpBuilder.readTimeout(readTimeout > 0 ? readTimeout : HttpConstants.readTimeoutDef, TimeUnit.SECONDS);

        singleOkHttpBuilder.writeTimeout(writeTimeout > 0 ? writeTimeout : HttpConstants.writeTimeoutDef, TimeUnit.SECONDS);

        singleOkHttpBuilder.connectTimeout(connectTimeout > 0 ? writeTimeout : HttpConstants.connectTimeoutDef, TimeUnit.SECONDS);
